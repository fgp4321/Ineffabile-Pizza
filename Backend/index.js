...
const municipios = [ "Agost", "Agres", "Aigües", "Alacant/Alicante", "Albatera", "Alcalalí", "Alcocer de Planes", "Alcoleja", "Alcoy/Alcoi", "Alfàs del Pi (l')", "Alfondeguilla", "Algorfa", "Algueña", "Alicante/Alacant", "Almoradí", "Almudaina", "Alqueria d'Asnar (l')", "Altea", "Aspe", "Balones", "Banyeres de Mariola", "Benasau", "Beneixama", "Benejúzar", "Benferri", "Beniarbeig", "Beniardá", "Beniarrés", "Benidoleig", "Benidorm", "Benifallim", "Benifato", "Benigembla", "Benijófar", "Benilloba", "Benillup", "Benimantell", "Benimarfull", "Benimassot", "Benimeli", "Benissa", "Benitachell/Poble Nou de Benitatxell", "Biar", "Bigastro", "Bolulla", "Busot", "Callosa d'en Sarrià", "Callosa de Segura", "Calpe/Calp", "Campello", "Campo de Mirra/Camp de Mirra", "Cañada", "Castalla", "Castell de Castells", "Catral", "Cocentaina", "Confrides", "Cox", "Crevillent", "Daya Nueva", "Daya Vieja", "Dénia", "Dolores", "Elche/Elx", "Elda", "Facheca", "Famorca", "Finestrat", "Fondó de les Neus/Hondón de las Nieves", "Formentera del Segura", "Gata de Gorgos", "Gorga", "Granja de Rocamora", "Guardamar del Segura", "Hondón de los Frailes", "Ibi", "Jacarilla", "Jávea/Xàbia", "Jijona/Xixona", "Llíber", "Lorcha/Orxa", "Millena", "Monforte del Cid", "Monóvar/Monòver", "Montesinos", "Murla", "Muro de Alcoy", "Mutxamel", "Novelda", "Nucia", "Ondara", "Onil", "Orba", "Orihuela", "Orxeta", "Parcent", "Pedreguer", "Pego", "Penàguila", "Petrer", "Pilar de la Horadada", "Pinoso", "Planes", "Poblets", "Polop", "Quatretondeta", "Rafal", "Ràfol d'Almúnia", "Redován", "Relleu", "Rojales", "Romana", "Sagra", "Salinas", "San Fulgencio", "San Isidro", "San Miguel de Salinas", "San Vicente del Raspeig/Sant Vicent del Raspeig", "Sanet y Negrals", "Sant Joan d'Alacant", "Santa Pola", "Sax", "Sella", "Senija", "Tàrbena", "Teulada", "Tibi", "Tollos", "Tormos", "Torremanzanas/Torre de les Maçanes", "Torrevieja", "Vall d'Alcalà", "Vall d'Ebo", "Vall de Gallinera", "Vall de Laguar", "Verger", "Villajoyosa/Vila Joiosa", "Villena" ];
